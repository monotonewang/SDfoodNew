package com.wang.sdfood.custem.cycleviewpager;
 ...
 */
public class CycleViewPagerM  extends Fragment implements ViewPager.OnPageChangeListener, View.OnTouchListener {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View view = LayoutInflater.from(getActivity()).inflate(me.codeboy.android.cycleviewpager.R.layout
        ...
        private void setIndicator(int selectedPosition) {
            for (int i = 0; i < indicators.length; i++) {
                indicators[i].setBackgroundResource(me.codeboy.android.cycleviewpager.R.drawable.cycleviewpager_indicator_circle_gray);
            }
            if (indicators.length > selectedPosition) {
                indicators[selectedPosition].setBackgroundResource(me.codeboy.android.cycleviewpager.R.drawable.cycleviewpager_indicator_circle_black);
            }
        }
